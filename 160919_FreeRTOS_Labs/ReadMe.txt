...
source code, along with a set of examples that target various hardware and
development tools.

Note:  The Windows demo can be used with free tools, and without the need for
any specific hardware - however it will not provide true real time behaviour, or
representative network throughput.
